...
export const metadata: Metadata = {
  title: "Homme — Ziziwatches",
  description: "Découvrez notre collection homme : montres, bijoux et accessoires.",
};
...
export default async function MenPage({ params, searchParams }: PageProps) {
  ...
  const where: Record<string, unknown> = { status: "ACTIVE", category: { slug: "montres-homme" } };
    ...
    <>
      ...
      <main className="min-h-screen">
        ...
        <div className="relative h-72 sm:h-80 lg:h-[420px] flex items-center justify-center">
          <Image src="/backk.png" alt="Homme" fill className="object-cover object-center" priority />
          ...
          <div className="relative z-10 text-center px-6 pt-16">
            ...
            <h1 className="luxury-heading text-5xl sm:text-6xl lg:text-7xl font-light text-white tracking-wide">Homme</h1>
          </div>
        </div>
        ...
        <SubCategoryCircles circles={[
          { label: "Show All",      href: `/${params.locale}/men`,                                       image: "/menwatche.png" },
          { label: "Watches",       href: `/${params.locale}/shop?category=montres-homme`,               image: "/menwatche.png" },
          { label: "Jewellery",     href: `/${params.locale}/jewellery`,                                 image: "/Men's bracelet.png" },
          { label: "Bestsellers",   href: `/${params.locale}/shop?category=montres-homme&sort=priceDesc`,image: "/star.png" },
          { label: "Gifts for Him", href: `/${params.locale}/gifts`,                                     image: "/gift.png" },
          { label: "Pack",          href: `/${params.locale}/packs`,                                     image: "/pack.png" },
        ]} />
        ...
        <div className="section-padding py-10">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            ...
            <div className="flex items-center gap-3">
              ...
              {(Object.keys(SORT_LABELS) as (keyof typeof SORT_LABELS)[]).map((s) => (
                <a
                  key={s}
                  href={`/${params.locale}/men?sort=${s}${q ? `&q=${q}` : ""}`}
          ...
          {products.length === 0 ? (
            ...
            <ProductDiamondGrid products={products} singleRow />
          )}
        </div>
