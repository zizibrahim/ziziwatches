...
export const metadata: Metadata = {
  title: "Femme — Ziziwatches",
  description: "Découvrez notre collection femme : montres élégantes et accessoires raffinés.",
};
...
export default async function WomenPage({ params, searchParams }: PageProps) {
  ...
  const where: Record<string, unknown> = { status: "ACTIVE", category: { slug: "montres-femme" } };
    ...
    <>
      ...
      <main className="min-h-screen">
        ...
        <div className="relative h-72 sm:h-80 lg:h-[420px] flex items-center justify-center">
          <Image src="/backk.png" alt="Femme" fill className="object-cover object-center" priority />
          ...
          <div className="relative z-10 text-center px-6 pt-16">
            ...
            <h1 className="luxury-heading text-5xl sm:text-6xl lg:text-7xl font-light text-white tracking-wide">Femme</h1>
          </div>
        </div>
        ...
        <SubCategoryCircles circles={[
          { label: "Show All",      href: `/${params.locale}/women`,                                        image: "/womenwatche.png" },
          { label: "Watches",       href: `/${params.locale}/shop?category=montres-femme`,                  image: "/womenwatche.png" },
          { label: "Jewellery",     href: `/${params.locale}/jewellery`,                                    image: "/bijouxwomen.png" },
          { label: "Bestsellers",   href: `/${params.locale}/shop?category=montres-femme&sort=priceDesc`,   image: "/bra3.jpeg" },
          { label: "Gifts for Her", href: `/${params.locale}/gifts`,                                        image: "/gift.png" },
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            ...
            <div className="flex items-center gap-3">
              ...
              {(Object.keys(SORT_LABELS) as (keyof typeof SORT_LABELS)[]).map((s) => (
                <a
                  key={s}
                  href={`/${params.locale}/women?sort=${s}${q ? `&q=${q}` : ""}`}
