        ...
        <div className="w-full max-w-lg">
          ...
          <div className="border border-border bg-surface p-8 md:p-10">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-xs tracking-[0.35em] uppercase text-gold mb-2 font-medium">
                Commande reçue
              </p>
            ...
            <div className="space-y-3 mb-8">
              ...
              <div className="flex items-center justify-between py-3 border-b border-border/50">
                ...
                <span className="text-gold font-medium text-sm">{formatPrice(total)}</span>
              </div>
              <div className="flex items-center justify-between py-3 border-b border-border/50">
            ...
            {/* Notice */}
            <div className="bg-gold/5 border border-gold/20 p-4 mb-8 flex gap-3">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <Link
                href={`/${locale}/shop`}
                className="flex-1 flex items-center justify-center gap-2 border border-border text-foreground/60 text-xs tracking-wider uppercase px-5 py-3 hover:border-gold/40 hover:text-foreground transition-colors"
              >
                <ArrowRight size={14} />
